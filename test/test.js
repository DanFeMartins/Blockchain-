...
contract("Healthchain", accounts => {
    ...
    beforeEach(async () => {
        ...
        await healthchain.cadastrarInstituicao(instituicaoAddress, "Instituicao de Teste", { from: instituicaoAddress });
        await healthchain.cadastrarInstituicao(instituicaoAddress2, "Outra Instituicao", { from: instituicaoAddress2 });
